...
#                   This was an introduction to binary classification. In machine learning this is a method
#                   for determining what of two categories a given observation belongs to. To show this, I created
#                   a simple naive Bayes classifier for SPAM email detection, and visualized the results.
...
# Return a single element vector of just the email body (uses words as features)
...
# Generate a TermDocumentMatrix (TDM) from the corpus of SPAM email.
...
# This is the workhorse function for classifying email. It returns the
# naive Bayes probability that the given email is SPAM.
...
# Generate a DocumentTermMatrix from that vector
spam.tdm <- get.tdm(all.spam)

# Generate a data frame that provides the feature set from the training SPAM data
